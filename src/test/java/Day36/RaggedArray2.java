...
public class RaggedArray2 {
    public static void main(String[] args) {
        ...
        System.out.println("Element of array[1][1] is " + raggedArray[1][4]); //printing fifth element of second row of "raggedArray"
        System.out.println("Element of array[1][1] is " + raggedArray[2][3]); //printing fourth element of third row of "raggedArray"
    }
}
